  ...
  return (
    <section className="bg-[url(/assets/images/proud-bg.png)] flex flex-col gap-0">
      ...
      <article className="flex flex-col">
        ...
        <div className="max-w-[1565px] w-full mx-auto mt-[-390px] px-4 flex flex-col gap-[65px] items-center pb-[395px] max-2xl:mt-[-285px] max-xl:pb-[100px] max-lg:mt-[-230px] max-lg:gap-[30px] max-md:mt-[-140px] max-sm:mt-[-50px] max-sm:gap-5">
          ...
          <span className="text-white text-xl font-bold leading-8 uppercase max-w-[1421px] w-full text-center max-xl:text-base max-lg:text-xs max-lg:mt-[-40px] max-lg:leading-[18px] max-lg:max-w-[750px] max-sm:mt-[0px]">
